...
@Entry("arrow_recover_objective", "Recover arrow objective", Colors.BLUE_VIOLET, "mdi:arrow-up-thick")
class ArrowRecoverObjectiveEntry(
    ...
    override suspend fun display(): AudienceFilter {
        return ArrowRecoverObjectiveDisplay(ref())
    }
}

private class ArrowRecoverObjectiveDisplay(ref: Ref<ArrowRecoverObjectiveEntry>) :
    BaseCountObjectiveDisplay<ArrowRecoverObjectiveEntry>(ref) {
