...
@Entry("dye_entity_objective", "Dye entity objective", Colors.BLUE_VIOLET, "mdi:palette")
class DyeEntityObjectiveEntry(
    ...
    override suspend fun display(): AudienceFilter {
        return DyeEntityObjectiveDisplay(ref())
    }
}

private class DyeEntityObjectiveDisplay(ref: Ref<DyeEntityObjectiveEntry>) :
    BaseCountObjectiveDisplay<DyeEntityObjectiveEntry>(ref) {
