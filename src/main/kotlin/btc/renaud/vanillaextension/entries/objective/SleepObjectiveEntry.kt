...
@Entry("sleep_objective", "Sleep objective", Colors.BLUE_VIOLET, "mdi:bed")
class SleepObjectiveEntry(
    ...
    override suspend fun display(): AudienceFilter {
        return SleepObjectiveDisplay(ref())
    }
}

private class SleepObjectiveDisplay(ref: Ref<SleepObjectiveEntry>) :
    BaseCountObjectiveDisplay<SleepObjectiveEntry>(ref) {
