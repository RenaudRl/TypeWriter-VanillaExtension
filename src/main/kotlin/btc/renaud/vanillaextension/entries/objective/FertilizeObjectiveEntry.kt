...
@Entry("fertilize_objective", "Fertilize objective", Colors.BLUE_VIOLET, "mdi:sprout")
class FertilizeObjectiveEntry(
    ...
    override suspend fun display(): AudienceFilter {
        return FertilizeObjectiveDisplay(ref())
    }
}

private class FertilizeObjectiveDisplay(ref: Ref<FertilizeObjectiveEntry>) :
    BaseCountObjectiveDisplay<FertilizeObjectiveEntry>(ref) {
