...
@Entry("fill_map_objective", "Fill map objective", Colors.BLUE_VIOLET, "mdi:map")
class FillMapObjectiveEntry(
    ...
    override suspend fun display(): AudienceFilter {
        return FillMapObjectiveDisplay(ref())
    }
}

private class FillMapObjectiveDisplay(ref: Ref<FillMapObjectiveEntry>) :
    BaseCountObjectiveDisplay<FillMapObjectiveEntry>(ref) {

    @EventHandler(priority = EventPriority.MONITOR, ignoreCancelled = true)
    fun onPlayerMapFilled(event: PlayerMapFilledEvent) {
