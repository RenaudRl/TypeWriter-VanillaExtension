...
@Entry("sign_write_objective", "Sign write objective", Colors.BLUE_VIOLET, "mdi:sign-text")
class SignWriteObjectiveEntry(
    ...
    override suspend fun display(): AudienceFilter {
        return SignWriteObjectiveDisplay(ref())
    }
}

private class SignWriteObjectiveDisplay(ref: Ref<SignWriteObjectiveEntry>) :
    BaseCountObjectiveDisplay<SignWriteObjectiveEntry>(ref) {
