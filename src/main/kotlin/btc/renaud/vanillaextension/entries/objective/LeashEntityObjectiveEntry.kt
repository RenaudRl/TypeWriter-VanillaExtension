...
@Entry("leash_entity_objective", "Leash entity objective", Colors.BLUE_VIOLET, "mdi:lasso")
class LeashEntityObjectiveEntry(
    ...
    override suspend fun display(): AudienceFilter {
        return LeashEntityObjectiveDisplay(ref())
    }
}

private class LeashEntityObjectiveDisplay(ref: Ref<LeashEntityObjectiveEntry>) :
    BaseCountObjectiveDisplay<LeashEntityObjectiveEntry>(ref) {
