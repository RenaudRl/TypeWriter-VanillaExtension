...
@Entry("barrel_open_objective", "An objective to open barrels", Colors.BLUE_VIOLET, "mdi:barrel")
class BarrelOpenObjectiveEntry(
    ...
    override suspend fun display(): AudienceFilter {
        return BarrelOpenObjectiveEntryDisplay(ref())
    }
}

private class BarrelOpenObjectiveEntryDisplay(ref: Ref<BarrelOpenObjectiveEntry>) :
    BaseCountObjectiveDisplay<BarrelOpenObjectiveEntry>(ref) {
