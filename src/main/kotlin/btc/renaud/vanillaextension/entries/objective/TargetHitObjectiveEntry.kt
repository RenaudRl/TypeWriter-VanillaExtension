...
@Entry("target_hit_objective", "Target hit objective", Colors.BLUE_VIOLET, "mdi:target")
class TargetHitObjectiveEntry(
    ...
    override suspend fun display(): AudienceFilter {
        return TargetHitObjectiveDisplay(ref())
    }
}

private class TargetHitObjectiveDisplay(ref: Ref<TargetHitObjectiveEntry>) :
    BaseCountObjectiveDisplay<TargetHitObjectiveEntry>(ref) {
