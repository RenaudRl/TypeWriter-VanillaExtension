...
@Entry("item_frame_remove_objective", "An objective to remove item frames", Colors.BLUE_VIOLET, "mdi:image-off")
class ItemFrameRemoveObjectiveEntry(
    ...
    override suspend fun display(): AudienceFilter {
        return ItemFrameRemoveObjectiveEntryDisplay(ref())
    }
}

private class ItemFrameRemoveObjectiveEntryDisplay(ref: Ref<ItemFrameRemoveObjectiveEntry>) :
    BaseCountObjectiveDisplay<ItemFrameRemoveObjectiveEntry>(ref) {
