...
@Entry("cauldron_fill_objective", "An objective to fill cauldrons", Colors.BLUE_VIOLET, "mdi:pot")
class CauldronFillObjectiveEntry(
    ...
    override suspend fun display(): AudienceFilter {
        return CauldronFillObjectiveEntryDisplay(ref())
    }
}

private class CauldronFillObjectiveEntryDisplay(ref: Ref<CauldronFillObjectiveEntry>) :
    BaseCountObjectiveDisplay<CauldronFillObjectiveEntry>(ref) {
    @EventHandler(priority = EventPriority.MONITOR)
    fun onCauldronFill(event: PlayerBucketEmptyEvent) {
