...
@Entry("raid_complete_objective", "Raid complete objective", Colors.BLUE_VIOLET, "mdi:flag-checkered")
class RaidCompleteObjectiveEntry(
    ...
    override suspend fun display(): AudienceFilter {
        return RaidCompleteObjectiveDisplay(ref())
    }
}

private class RaidCompleteObjectiveDisplay(ref: Ref<RaidCompleteObjectiveEntry>) :
    BaseCountObjectiveDisplay<RaidCompleteObjectiveEntry>(ref) {
