...
@Entry("portal_use_objective", "Use portal objective", Colors.BLUE_VIOLET, "mdi:portal")
class PortalUseObjectiveEntry(
    ...
    override suspend fun display(): AudienceFilter {
        return PortalUseObjectiveDisplay(ref())
    }
}

private class PortalUseObjectiveDisplay(ref: Ref<PortalUseObjectiveEntry>) :
    BaseCountObjectiveDisplay<PortalUseObjectiveEntry>(ref) {
