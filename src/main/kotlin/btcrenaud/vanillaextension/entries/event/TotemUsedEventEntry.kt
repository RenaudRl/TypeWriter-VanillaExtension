...
@Entry("on_totem_used_event", "A trigger for when players use a totem of undying", Colors.YELLOW, "ph:heart-bold")
/**
...
private class TotemUsedTriggerDisplay(private val ref: Ref<TotemUsedEventEntry>) : AudienceFilter(ref) {
