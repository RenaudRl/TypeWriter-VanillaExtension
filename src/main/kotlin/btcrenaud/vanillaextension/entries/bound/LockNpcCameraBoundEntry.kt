package btcrenaud.vanillaextension.entries.bound
...
import btcrenaud.vanillaextension.events.LockNpcCameraNavigationDirection
import btcrenaud.vanillaextension.events.LockNpcCameraNavigationEvent
import btcrenaud.vanillaextension.events.LockNpcCameraNavigationInput
...
class LockNpcCameraBoundEntry(
    ...
    private fun resolveAnchor(player: Player, interactionContext: InteractionContext?): Anchor? {
        val contextNpcRef = interactionContext?.get(InteractingEntityInstance)
        val ref =
