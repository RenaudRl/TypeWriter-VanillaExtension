package btcrenaud.vanillaextension
...
import btcrenaud.vanillaextension.ObjectiveDisplay
...
interface BaseCountObjectiveEntry : ObjectiveEntry {
    ...
    override fun display(player: Player?): String {
        ...
        if (player == null || !player.isQuestActive(quest) || !criteria.matches(player)) {
            return inactiveObjectiveDisplay.replaceTagPlaceholders("display", displayText).parsePlaceholders(player)
        }

        val factEntry = fact.get() ?: return inactiveObjectiveDisplay.replaceTagPlaceholders("display", displayText).parsePlaceholders(player)
